...
if(typeof(speechSynthesis)!='undefined'){if(typeof(speechSynthesis.getVoices)=='function')NSB.loadVoices();window.speechSynthesis.onvoiceschanged=function(){NSB.loadVoices()};}
...
return;}
if(typeof(NSB.ShowProgressobj)==='undefined'||NSB.ShowProgressobj===null){NSB.ShowProgressobj=document.createElement("div");NSB.ShowProgressobj.id="NSB_Progress";NSB.ShowProgressobj.setAttribute("class","modal");document.body.appendChild(NSB.ShowProgressobj);NSB.ShowProgressobj.onclick=function(){$.jqmodal.close();};}
